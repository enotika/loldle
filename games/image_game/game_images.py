...
class ImageGame(tk.Frame):
    def __init__(self, parent):
        ...
        # Заголовок
        self.title_label = tk.Label(self, text="Игра картинки", font=("Arial", 24))
    ...
    def load_random_image(self):
        ...
        image_folder_addres = "data/champ_images/" + self.random_folder + "/" + self.random_folder + "_skins"
    ...
    def check_answer(self, event=None):
        ...
        if answer == self.random_folder.lower():
            ...
            self.count_expand+=1
            expanded_image = random_image_part.expand_img(self.image_address, 200, 200, self.expand_sz)
